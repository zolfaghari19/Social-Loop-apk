...
class AppDatabase {
  ...
  static List<Category> get categories {
    return [
      ...
      Category(id: 102, title: 'Top Apk', imageFileName: 'large_post_2.jpg'),
      Category(
          id: 103, title: 'Ps Ai', imageFileName: 'large_post_3.jpg'),
      Category(id: 104, title: 'Explore', imageFileName: 'large_post_4.jpg'),
      Category(
          id: 105,
          title: 'Card For Pay',
          imageFileName: 'large_post_5.jpg'),
      Category(id: 106, title: 'Youtube', imageFileName: 'large_post_6.jpg'),
    ];
  }
  ...
  static List<PostData> get posts {
    return [
      PostData(
          id: 1,
          title: 'News For Technology 2025',
          caption: 'News Today',
          isBookmarked: false,
          likes: '3.1k',
          time: '1hr ago',
      ...
      PostData(
          id: 0,
          title: 'MacBook Pro with Iphone 16',
          caption: 'Analyzes the new Payments',
          isBookmarked: false,
          likes: '1.2k',
          time: '2hr ago',
